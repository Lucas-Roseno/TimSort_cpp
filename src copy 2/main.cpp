...
#define TEST_STRUCTURE_NAME "dynamicList"
...
int main() {
    ...
    long max_rss_from_rusage = MemoryMonitor::getMaxRSS();
    std::cout << "Pico de memória medido com getrusage (equivalente ao time -v): " << max_rss_from_rusage << " KB." << std::endl;
